...
expName = 'alternatingbabyloc'  # from the Builder filename that created this script
expInfo = {
...
for run_num in range(run_num, 9):
    # loop thru the following steps if run is static and short
    if run_num % 2 == 0 and run_num <= 4:
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'combined' + '/' + 'script_babyloc_static_short_run' + str(run_num) + '.csv'
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'combined' + '/'+ str(experiment_info_header)
        ...
        #Begin Routine tab
        last_image_directory = f'/Users/{usr}/Desktop/alternating_bb/alternating_psychopy/countdown_imgs/'
        ...
        par_file_df.to_csv(_thisDir + os.sep + u'data/' + str(participant) + '/' + 'combined' + '/' + experiment_info_header + 'short_static_par_file.par', sep='\t', index=False, header=False, lineterminator='\n')
        print("Par file exported successfully!")
        print(f"Finished processing run {run_num}")
        
    # loop thru the following steps if run is dynamic and short 
    elif run_num % 2 != 0 and run_num <= 4: 
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'combined' + '/' + 'script_babyloc_dyna_short_run' + str(run_num) + '.csv'
        ...
        # export conditions par file
        par_file_df.to_csv(_thisDir + os.sep + u'data/' + str(participant) + '/' + 'combined' '/' + experiment_info_header + 'short_dynamic_par_file.par', sep='\t', index=False, header=False, lineterminator='\n')
        print("Par file exported successfully!")
    
    elif run_num % 2 == 0 and run_num > 4:
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'combined' + '/' + 'script_babyloc_static_long_run' + str(run_num) + '.csv'
        ...
        # export conditions par file
        par_file_df.to_csv(_thisDir + os.sep + u'data/' + str(participant) + '/' + 'combined' + '/' + experiment_info_header + 'static_long_par_file.par', sep='\t', index=False, header=False, lineterminator='\n')
        print("Par file exported successfully!")
        print(f"Finished processing run {run_num}")
        
    # loop thru the following steps if run is dynamic long (run_num greater than 4 and divisble by 2)
    else: 
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'combined' + '/' + 'script_babyloc_dyna_long_run' + str(run_num) + '.csv'
        ...
        # export conditions par file
        par_file_df.to_csv(_thisDir + os.sep + u'data/' + str(participant) + '/' + 'combined' '/' + experiment_info_header + 'dynamic_long_par_file.par', sep='\t', index=False, header=False, lineterminator='\n')
        print("Par file exported successfully!")
