function make_sblocks_2reps(participant, run)
%% Generates blocks for Stigliani's static fLoc; 2 reps per category 
...
for r = 1:nruns
    ...
    condvec = repmat([1:ncats], 1, 2);  % Each category repeats exa2tly2  times
