# bbfloc
We have four working experiment versions: combined; short, mid, and long. The runs for each experiment version are generated by Matlab functions; made unique for each subject. The experiment versions run on PsychoPy.
