...
All experiment stuff will be kept in a folder called **'alternating_bb'** on your DESKTOP. You can grab this folder from the following path and store it locally: /Volumes/group/biac2/kgs/projects/bbfloc/alternating_bb
