...
- Make_order_babyloc_dyna_long generates **4 dynamic runs** in the participant's folder, with **12 repeats** per category, and no repeats in actors within a run. Its generated CSVs will be used for running the 'short' experiment on PsychoPy.
     - Each block contains a unique 4s video.
- Make_order_babyloc_static_long generates **4 static runs** in the participant's folder, with **12 repeats** per category, and no repeats in images within a run. Its generated CSVs will be used for running the 'short' experiment on PsychoPy.
    - Each block contains 8 unique images presented at .5 seconds each.
