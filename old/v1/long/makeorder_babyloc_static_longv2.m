...
for r = 1:nruns
    condvec = [shuffle([1:5]) shuffle([1:5]) shuffle([1:5])  shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5])  shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5])  shuffle([1:5])]    % generate the order of the stim presentation
    % Check for consecutive repetitions and reshuffle if found
    while any(diff(condvec) == 0)
        condvec = [shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5])  shuffle([1:5]) shuffle([1:5]) shuffle([1:5]) shuffle([1:5])  shuffle([1:5])];
    end
