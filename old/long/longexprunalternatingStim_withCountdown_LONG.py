...
for run_num in range(1, 9):
    # assign first two runs as static and 5th and 6th runs as static
    if run_num <= 2 or (5 <= run_num <= 6):
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + 'script_babyloc_static_2Hz_run' + str(run_num) + '.csv'
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + str(experiment_info_header)
...
#        
        ...
        par_file_df.to_csv(_thisDir + os.sep + u'data/' + str(participant) + '/' + 'long' + '/' + experiment_info_header + 'static_par_file.par', sep='\t', index=False, header=False, lineterminator='\n')
        print("Par file exported successfully!")
        print(f"Finished processing run {run_num}")
        
    # assign third and fourth and last two runs as dynamic
    else: 
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + 'script_babyloc_dyna_2Hz_run' + str(run_num) + '.csv'
