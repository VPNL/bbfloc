...
for run_num in range(run_num, 17):
    ...
    if run_num <= 2 or (5 <= run_num <= 6) or (9 <= run_num <= 10) or (13 <= run_num <= 14):
        ...
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'short' + '/' + 'script_babyloc_static_short_run' + str(run_num) + '.csv'
    ...
    # loop thru the following steps if run_num >=2
                ...
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'short' + '/' + 'script_babyloc_dyna_short_run' + str(run_num) + '.csv'
