...
expName = 'newbabyloc_shortblocks'  # from the Builder filename that created this script
expInfo = {
...
for run_num in range(run_num, 5):
    if run_num % 2 == 0:
        #loop thru if run_num is static
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'shortblock' + '/' + 'script_babyloc_static_shortblock_run' + str(run_num) + '.csv'
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'shortblock' + '/'+ str(experiment_info_header)
        ...
        # ===== Generate par files for static short block run =====
        color_codes = {
            0: '0 0 0',     # blank
            1: '1 0 0',     # faces
            2: '0.8 0.8 0', # hands
        ...
        # Define the path to the shortblock folder
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'shortblock' + '/' + 'run' + str(run_num) + '.par'
    ...
    # loop thru the following steps if run is dynamic
    else:
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'shortblock' + '/' + 'script_babyloc_dyna_shortblock_run' + str(run_num) + '.csv'
    ...
    # ====== Generate parfiles for dynamic shortblock runs  =============
        # Create an empty list to store parfile data
        par_file_data = []
