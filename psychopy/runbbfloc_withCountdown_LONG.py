# --- Loads eight unique long length runs: 1) static; 2) static; 3) dynamic; 4) dynamic; 5) static; 6) static; 7) dynamic; 8) dynamic
...
for run_num in range(run_num, 9):
    ...
    if run_num <= 2 or (5 <= run_num <= 6):
        ...
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + 'run' + str(run_num) + '.par'
