...
for run_num in range(run_num, 13):
    # loop thru the following steps if run_num is even (static condition)
    if run_num % 2 != 0:
        # ======================== experiment set-up ============================ 
    ...
    # loop thru the following steps if run_num is even (dynamic)
    else: 
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
