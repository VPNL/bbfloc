...
for run_num in range(1, 9):
    ...
    if run_num <= 2 or (5 <= run_num <= 6):
        ...
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'mid' + '/' + 'script_babyloc_static_2Hz_run' + str(run_num) + '.csv'
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'mid' + '/' + str(experiment_info_header)
...
#        
    ...
    # assign third and fourth and last two runs as dynamic
                ...
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'mid' + '/' + 'script_babyloc_dyna_2Hz_run' + str(run_num) + '.csv'
