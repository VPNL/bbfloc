...
for run_num in range(run_num, 9):
    ...
    if run_num <= 2 or (5 <= run_num <= 6):
        ...
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + 'script_babyloc_static_long_run' + str(run_num) + '.csv'
    ...
    # loop thru the following steps if run_num >=2
                ...
                # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'long' + '/' + 'script_babyloc_dyna_long_run' + str(run_num) + '.csv'
